 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://ws.vacaystayconnect.com/quote}paymentSchedule" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "paymentSchedules")
public class PaymentSchedules {

    @XmlElement(required = true)
    protected List<PaymentSchedule> paymentSchedule;
    ...
    public List<PaymentSchedule> getPaymentSchedule() {
        if (paymentSchedule == null) {
            paymentSchedule = new ArrayList<PaymentSchedule>();
        }
