...
public class DateCompareReserveImpl implements ConstraintValidator<DateCompareReserve, Object>{

	private String startDatePropertyName;
	private String endDatePropertyName;
	@Override
	public void initialize(DateCompareReserve dateCompareReserve) {
