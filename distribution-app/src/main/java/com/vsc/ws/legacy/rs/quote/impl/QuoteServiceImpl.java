package com.vsc.ws.legacy.rs.quote.impl;
...
import com.vsc.legacy.model.quote.response.Success;
import com.vsc.legacy.model.quote.response.VSCQuoteRS;
import com.vsc.legacy.validation.validator.QuoteServiceValidator;
import com.vsc.ws.legacy.rs.common.BaseService;
import com.vsc.ws.legacy.rs.quote.QuoteService;

public class QuoteServiceImpl extends BaseService implements QuoteService {
	
	@Autowired
	private RestTemplate restTemplate;
	@Value("${legacy.quote.quotes.api.url}")
